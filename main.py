...
if __name__ == '__main__':
    print(run_experiment_once(activations=data.get_data(), max_dimension=1,
                        distances=get_all_distances_no_param(alphas, thresholds), summaries=get_all_summaries(),
                        samples_neurons=nNeurons, samples_examples=nExamples, sample_neurons_strategy=random_indices,
